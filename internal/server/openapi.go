...
func schemas() map[string]any {
	return map[string]any{
		...
		"ProductRequiredService":     object(map[string]any{"index": map[string]any{"type": "integer"}, "service_ref": stringSchema("Canonical service reference."), "label": stringSchema("Display label for tree rendering."), "role": stringSchema("Fulfillment role."), "required": map[string]any{"type": "boolean"}, "description": stringSchema("Description."), "resolution_status": stringSchema("resolved, missing, unresolved_domain, or unresolved_service."), "fulfillment_type": stringSchema("local, cross-domain, or unresolved."), "cross_domain": map[string]any{"type": "boolean"}, "sla_ref": stringSchema("Optional SLA reference."), "ola_ref": stringSchema("Optional OLA reference."), "tree_target": stringSchema("Resolved service selection target."), "service_selection": stringSchema("Resolved service selection target."), "fulfillment_selection": stringSchema("Stable fulfillment selection target."), "resolved_label": stringSchema("Resolved service display label."), "sla": schemaRef("ServiceLevel"), "ola": schemaRef("ServiceLevel"), "service_level_label": stringSchema("Compact SLA/OLA label for tree display.")}),
