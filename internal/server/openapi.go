...
func schemas() map[string]any {
	return map[string]any{
		...
		"ProductRequiredService":     object(map[string]any{"service_ref": stringSchema("Canonical service reference."), "role": stringSchema("Fulfillment role."), "required": map[string]any{"type": "boolean"}, "description": stringSchema("Description."), "resolution_status": stringSchema("resolved, missing, unresolved_domain, or unresolved_service."), "fulfillment_type": stringSchema("local service, cross-domain service, unresolved domain, or missing service."), "cross_domain": map[string]any{"type": "boolean"}, "sla": schemaRef("ServiceLevel"), "ola": schemaRef("ServiceLevel"), "service_level_label": stringSchema("Compact SLA/OLA label for tree display.")}),
