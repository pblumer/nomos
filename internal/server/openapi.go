...
func schemas() map[string]any {
	return map[string]any{
		...
		"Blueprint":            object(map[string]any{"id": stringSchema("Blueprint id."), "type": stringSchema("Blueprint type."), "name": stringSchema("Name."), "version": stringSchema("Version."), "status": stringSchema("Status."), "owner": stringSchema("Owner."), "summary": stringSchema("Summary."), "path": stringSchema("Filesystem path."), "required_inputs": arrayOf(map[string]any{"type": "string"}), "required_service_blueprints": arrayOf(map[string]any{"type": "string"}), "required_services": arrayOf(map[string]any{"type": "object", "additionalProperties": true}), "requirements": arrayOf(schemaRef("BlueprintRequirement")), "attributes": arrayOf(schemaRef("BlueprintAttribute"))}),
